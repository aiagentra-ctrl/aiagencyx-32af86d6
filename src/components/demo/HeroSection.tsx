...
const HeroSection = ({
  ...
  const title =
    heroTitle ||
    (clientName
      ? `Hey ${clientName}, meet your AI Voice Agent`
      : "Meet Your AI Voice Agent");

  const subtitle =
    heroSubtitle ||
    (companyName
      ? `We built a custom AI Voice Agent for ${companyName} that can automate customer calls and responses — 24/7.`
      : "Automate customer calls and responses with a custom AI Voice Agent built for your business.");
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-accent/5 px-6 py-20 md:py-32">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Button size="lg" className="gap-2 px-8 text-base" onClick={onTryDemo}>
